...
- [ ] 22. [sufficient-grade-traverse](step-sufficient-grade-traverse.md) — the traversal leg; does the fold disappear rather than merely lose its casts
- [ ] 23. [sufficient-grade-morphism](step-sufficient-grade-morphism.md) — the morphism leg; a grade morphism need only be monotone, not a homomorphism
